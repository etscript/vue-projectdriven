...
export default {
  ...
  methods: {
    getComment() {
      this.$post('/api/comment/person', this.pageModel1).then(res => {
        this.loading = false
    ...
    deleteComment(item) {
      ...
      this.$post('/api/comment/delete', param).then(res => {
    ...
    getMessage() {
      this.$post('/api/message/person', this.pageModel2).then(res => {
        this.loading = false
    ...
    deleteMessage(item) {
      ...
      this.$post('/api/message/delete', param).then(res => {
